...
### Here we aggregate stem-level data up to the plot-level, to enable NAPP estimates
...
```{r figure-aboveground biomass over time, fig.width = 4, fig.height = 4, echo=FALSE, message = FALSE, warning=FALSE, fig.cap = "Biomass at LUMCON marshes."}
...
```{r figure-correlations between NAPP estimates, fig.width = 4, fig.height = 4, echo=FALSE, warning=FALSE, fig.cap = "Correlations between NAPP estimates."}
...
```{r table-correlations between NAPP estimates, echo=FALSE, warning=FALSE, fig.cap = "Correlations between NAPP estimates."}
