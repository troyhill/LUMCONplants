...
```{r allometry exponents and coefficients, fig.width = 3.5, fig.height = 3, warning=FALSE, echo=FALSE, fig.cap = "Relationship between allometry coefficients and exponents (one model for each marsh-season)."}
